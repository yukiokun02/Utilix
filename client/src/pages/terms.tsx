      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-300 font-medium">Please read our terms and conditions</p>
          </div>
          <Link href="/">
        ...
        <Card className="solid-card">
          <CardContent className="p-8 prose prose-invert max-w-none">
            ...
            <div className="space-y-8 text-foreground">
              ...
              <section>
                <h2 className="text-xl font-bold mb-4 text-blue-400">1. Use of the Website</h2>
              ...
              <section>
                <h2 className="text-xl font-bold mb-4 text-blue-400">2. Intellectual Property</h2>
                <p className="leading-relaxed">
              ...
              <section>
                <h2 className="text-xl font-bold mb-4 text-blue-400">3. User-Generated Content</h2>
                <p className="leading-relaxed">
              ...
              <section>
                <h2 className="text-xl font-bold mb-4 text-blue-400">4. Third-Party Links</h2>
                <p className="leading-relaxed">
              ...
              <section>
                <h2 className="text-xl font-bold mb-4 text-blue-400">5. Disclaimer of Warranties</h2>
                <p className="leading-relaxed">
              ...
              <section>
                <h2 className="text-xl font-bold mb-4 text-blue-400">6. Limitation of Liability</h2>
                <p className="leading-relaxed">
              ...
              <section>
                <h2 className="text-xl font-bold mb-4 text-blue-400">7. Changes to These Terms</h2>
                <p className="leading-relaxed">
